...
const servicioFinalizado = ({ navigation }) => {
      ...
      {loading ? (
        ...
        <View>
          ...
          >
            ...
            >
              <Text style={{color:"#00FF0A"}}>Abrir chat</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={{color:"red"}}>Informar un problema</Text>
            </TouchableOpacity>
          </View>
        </View>
      )}
...
export default servicioFinalizado;
